...
// A cmp function for determining which segments should take visual priority
	function compareSegs(seg1, seg2) {
		return (seg1.event.className.indexOf('closed') == -1) - (seg2.event.className.indexOf('closed') == -1) ||
	...
	$.extend(DayGrid.prototype, {
		...
		renderSegHtml: function(seg, disableResizing) {
			...
			if (!event.allDay && seg.isStart && event.className.indexOf('closed') == -1) {
	...
	$.extend(TimeGrid.prototype, {
		...
		renderSegHtml: function(seg, disableResizing) {
			...
			return '<a class="' + classes.join(' ') + '"' +
				...
				'>' +
				'<div class="fc-content">' +
				((event.className.indexOf('closed') == -1) ?
					(timeText ?
					'<div class="fc-time"' +
		...
		generateSegPositionCss: function(seg) {
			...
			// We doesn't want % the width of events
			left = 0;
			right = 0;
